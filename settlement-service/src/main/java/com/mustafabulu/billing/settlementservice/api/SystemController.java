...
import com.mustafabulu.billing.settlementservice.application.HealthProbeService;
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            examples = @ExampleObject(
                                    value = "{\"status\":\"UP\",\"service\":\"settlement-service\",\"timestamp\":\"2026-02-21T16:30:00Z\"}"
                            )
                    )
            )
